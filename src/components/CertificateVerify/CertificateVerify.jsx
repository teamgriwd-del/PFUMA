          ...
          {result === undefined ? (
            ...
            <>
              <div className="bg-pfuma-green px-6 py-5 flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-bold text-sm uppercase tracking-wide">Certificate Valid</p>
                  <p className="text-green-100 text-xs font-medium">Issued {new Date(result.created_at).toLocaleDateString()}</p>
                </div>
              </div>
            ...
            <>
              <div className="bg-gray-800 px-6 py-5 flex items-center gap-3">
                ...
                <p className="text-white font-bold text-sm uppercase tracking-wide">Certificate Not Found</p>
              </div>
              <div className="p-6">
