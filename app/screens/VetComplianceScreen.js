...
const styles = StyleSheet.create({
  ...
  headerEyebrow: { color: '#DAE7E5', fontSize: 10, fontFamily: FONTS.extrabold, textTransform: 'uppercase', letterSpacing: 2 },
  ...
  statLabel:{ fontSize: 9, fontFamily: FONTS.extrabold, color: COLORS.muted, textTransform: 'uppercase', marginTop: 2 },
  ...
  errorBanner: { fontSize: 11, fontFamily: FONTS.extrabold, color: '#9A2A23', backgroundColor: '#F6D9D5', padding: 10, borderRadius: 12, marginBottom: 10 },
  emptyCard: { backgroundColor: '#fff', borderRadius: 20, padding: 30, alignItems: 'center' },
  emptyText: { fontSize: 13, fontFamily: FONTS.extrabold, color: COLORS.text, marginTop: 10, textAlign: 'center' },
  ...
  metaText: { fontSize: 11, fontFamily: FONTS.bold, color: COLORS.muted },
  caseMsg:  { fontSize: 12, fontFamily: FONTS.bold, marginTop: 6, lineHeight: 17 },

  blockerBox:   { marginTop: 10, backgroundColor: '#fff', borderRadius: 12, padding: 10, borderWidth: 1, borderColor: 'rgba(63,112,107,0.25)' },
  blockerTitle: { fontSize: 11, fontFamily: FONTS.extrabold, color: COLORS.teal },
  blockerNotes: { fontSize: 11, color: COLORS.muted, marginTop: 3, fontStyle: 'italic' },
  blockerMeta:  { fontSize: 9, fontFamily: FONTS.bold, color: COLORS.muted, textTransform: 'uppercase', marginTop: 4 },

  rowGap:    { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 8 },
  graceText: { fontSize: 11, fontFamily: FONTS.bold, color: COLORS.muted },
  ...
  actionBtnOutlineText: { fontSize: 10, fontFamily: FONTS.extrabold, textTransform: 'uppercase', color: COLORS.muted },
  actionBtnBlue: { backgroundColor: COLORS.teal, borderRadius: 12, paddingHorizontal: 12, paddingVertical: 9 },
  actionBtnBlueText: { fontSize: 10, fontFamily: FONTS.extrabold, textTransform: 'uppercase', color: '#fff' },
  ...
  actionBtnRedText: { fontSize: 10, fontFamily: FONTS.extrabold, textTransform: 'uppercase', color: '#fff' },
  ...
  waiveText: { fontSize: 10, fontFamily: FONTS.extrabold, textTransform: 'uppercase', color: COLORS.muted, paddingVertical: 9 },
});
