...
const styles = StyleSheet.create({
  ...
  selectedCount: { fontSize: 11, fontWeight: '800', color: COLORS.primary },
  ...
  catName:     { fontSize: 10, fontWeight: '800', color: COLORS.muted, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 },
  ...
  runBtnText: { color: '#fff', fontSize: 12, fontWeight: '800', textTransform: 'uppercase' },
  resetBtn:   { paddingHorizontal: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.bg, borderRadius: 16 },

  resultsHeading: { fontSize: 12, fontWeight: '800', color: COLORS.text, marginBottom: 10, marginTop: 4 },
  savedFeedback:  { fontSize: 11, fontWeight: '800', color: '#465032', backgroundColor: COLORS.sproutBg, borderWidth: 1, borderColor: '#C9D2B4', borderRadius: 12, padding: 10, marginBottom: 10 },
  ...
  topBadgeText:  { color: '#fff', fontSize: 9, fontWeight: '900', textTransform: 'uppercase' },
  sevBadge:      { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  sevBadgeText:  { fontSize: 9, fontWeight: '900', textTransform: 'uppercase' },
  ...
  quarantineBadgeText: { fontSize: 9, fontWeight: '900', color: '#71360B', textTransform: 'uppercase' },

  resultName:    { fontSize: 17, fontWeight: '900', color: COLORS.text, marginBottom: 2 },
  ...
  confText:      { fontSize: 10, color: COLORS.muted, fontWeight: '700', marginTop: 4 },
  expandToggle:  { fontSize: 11, fontWeight: '800', color: COLORS.muted, textTransform: 'uppercase' },

  saveRow:     { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: COLORS.bg, borderRadius: 12, padding: 10, marginBottom: 12 },
  saveLabel:   { fontSize: 11, fontWeight: '800', color: COLORS.muted },
  ...
  animalPickText: { fontSize: 11, fontWeight: '700', color: COLORS.text },
  saveBtn:     { backgroundColor: COLORS.primary, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 10 },
  saveBtnText: { color: '#fff', fontSize: 11, fontWeight: '800' },
  ...
  vetBtnTitle: { color: '#fff', fontSize: 12, fontWeight: '800' },
