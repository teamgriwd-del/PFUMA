...
const styles = StyleSheet.create({
  ...
  animalChipText:{ fontSize: 12, fontWeight: '800', color: '#fff' },

  feedbackBanner: { fontSize: 11, fontWeight: '800', color: '#465032', backgroundColor: COLORS.sproutBg, borderWidth: 1, borderColor: '#C9D2B4', margin: 16, marginBottom: 0, padding: 10, borderRadius: 12 },
  ...
  infoTabText:   { fontSize: 10, fontWeight: '800', textTransform: 'uppercase', color: COLORS.muted },
  ...
  infoRowLabel: { fontSize: 12, fontWeight: '700', color: COLORS.muted },
  infoRowValue: { fontSize: 12, fontWeight: '800', color: COLORS.text },
  ...
  gestationDate:{ fontSize: 12, fontWeight: '800', color: COLORS.text },
  gestationSub: { fontSize: 11, color: COLORS.muted, marginTop: 2 },

  breedName:   { fontSize: 17, fontWeight: '900', color: COLORS.text, marginBottom: 4 },
  breedStat:   { flex: 1, backgroundColor: COLORS.bg, borderRadius: 12, padding: 10 },
  breedStatLabel: { fontSize: 9, fontWeight: '800', color: COLORS.muted, textTransform: 'uppercase' },
  breedStatValue: { fontSize: 12, fontWeight: '800', color: COLORS.text, marginTop: 2 },
  ...
  recName:    { fontSize: 12, fontWeight: '800', color: COLORS.text },
  recSub:     { fontSize: 11, color: COLORS.muted, marginTop: 2 },
  recStatus:  { fontSize: 10, fontWeight: '800', color: COLORS.muted, textTransform: 'uppercase', marginTop: 3 },
  recWarn:    { fontSize: 10, fontWeight: '700', color: '#9A2A23', marginTop: 3 },
  administerBtn: { backgroundColor: COLORS.primary, paddingHorizontal: 12, paddingVertical: 9, borderRadius: 10 },
  administerBtnText: { color: '#fff', fontSize: 11, fontWeight: '800' },
  ...
  taskName: { fontSize: 12, fontWeight: '800', color: COLORS.text },
  taskSub:  { fontSize: 10, fontWeight: '700', textTransform: 'uppercase', marginTop: 2 },
  ...
  doneBtnText: { color: '#fff', fontSize: 10, fontWeight: '800', textTransform: 'uppercase' },

  medRow:  { backgroundColor: COLORS.bg, borderRadius: 12, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: 'transparent' },
  medName: { fontSize: 12, fontWeight: '800', color: COLORS.text },
  medStock:{ fontSize: 12, fontWeight: '900', color: COLORS.text },
