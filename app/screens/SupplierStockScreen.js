...
const styles = StyleSheet.create({
  ...
  headerEyebrow: { color: '#fff', fontSize: 10, fontFamily: FONTS.extrabold, textTransform: 'uppercase', letterSpacing: 2 },
  ...
  postBtnText:   { fontSize: 11, fontFamily: FONTS.extrabold, color: COLORS.gold, textTransform: 'uppercase' },
  ...
  stockName:  { fontSize: 13, fontFamily: FONTS.extrabold, color: COLORS.text },
  stockCategory: { fontSize: 10, fontFamily: FONTS.bold, color: COLORS.muted, textTransform: 'uppercase', marginTop: 2 },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 10 },
  statusBadgeText: { fontSize: 9, fontFamily: FONTS.extrabold, textTransform: 'uppercase' },

  rowGap:  { flexDirection: 'row', alignItems: 'center', gap: 4 },
  qtyText: { fontSize: 14, fontFamily: FONTS.extrabold, color: COLORS.text },
  outOfStockText: { fontSize: 11, fontFamily: FONTS.extrabold, color: '#9A2A23' },
  lowStockText:   { fontSize: 10, fontFamily: FONTS.extrabold, color: '#8C632A', textTransform: 'uppercase' },
  ...
  restockBtnText: { color: '#fff', fontSize: 11, fontFamily: FONTS.extrabold, textTransform: 'uppercase' },
  errorText: { fontSize: 10, fontFamily: FONTS.bold, color: '#9A2A23', marginTop: 6 },
});
