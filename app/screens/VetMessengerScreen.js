...
const ROLE_META = {
  ...
  Farmer:   { icon: Sprout,      color: '#57633E',       label: 'Farmers' },
...
const CAT_COLORS  = { Emergency: '#B5342C', Vaccination: COLORS.primary, 'Trade Certification': '#41586C', General: '#555' };
...
export default function VetMessengerScreen({ currentUser, route }) {
          ...
          {loadingDirectory ? (
            ...
            <View key={g.type}>
              <View style={s.sectionLabelRow}>
                <g.meta.icon size={12} color="#968C82" strokeWidth={2.5} />
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#EFE8DD' }}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        <View style={s.inputBar}>
          <TouchableOpacity style={s.attachBtn} onPress={pickAttachment} activeOpacity={0.8}>
            <Paperclip size={19} color="#968C82" />
          </TouchableOpacity>
          <TextInput
            style={s.textInput}
...
const s = StyleSheet.create({
  ...
  inputBar:        { flexDirection: 'row', alignItems: 'flex-end', backgroundColor: '#fff', paddingHorizontal: 14, paddingVertical: 10, borderTopWidth: 1, borderTopColor: '#E0D6C7', gap: 10 },
  textInput:       { flex: 1, backgroundColor: '#EFE8DD', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 10, fontSize: 14, color: '#29231E', maxHeight: 100 },
