...
Every legal claim in this document is grounded in the research collected in [`compliance-research/`](../compliance-research/), which cites primary and secondary Zimbabwean legal sources (ZimLII, law.co.zw, FAOLEX, CVSZ, ZRP statements, Consumer Council of Zimbabwe, and others). Where a specific detail could not be independently confirmed from a primary source, `compliance-research/` says so explicitly rather than presenting it as settled fact — see Section 3.
